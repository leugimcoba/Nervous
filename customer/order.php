	...
	<form method="POST" action="purchase.php">
				...
				<?php 
					...
					while($row=$query->fetch_array()){
						...
						<tr>
							...
							<td><img src="<?php echo $row["photo"]; ?>" height="150px;" width="150px"></td>
							<td><?php echo $row['productname']; ?></td>
							<td class="text-right">Php <?php echo number_format($row['price'], 2); ?></td>
		...
		<div class="row">
			...
			<div class="col-md-2" style="margin-left:-20px;">
				<button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-disk"></span> Order Now</button>
			</div>
		</div>
	</form>
</div>
